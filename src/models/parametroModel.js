...
function cadastrar(parametro, tipoParametro, fkEmpresa) {
    var instrucaoSql = `
        INSERT INTO parametroRecomendacao (parametro, tipoParametro, fkEmpresa) VALUES ('${parametro}', '${tipoParametro}', '${fkEmpresa}');
    `;
